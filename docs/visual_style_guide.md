...
### 2.2 Правила для 2D-ассетов в 3D

- Рендеринг: `[SPRITE3D / BILLBOARD / MESH / OTHER]`
- Ориентация: `[FRONT / THREE_QUARTER / OTHER]`
- Поворот выполняется в Godot, а не запекается в изображение.
- Pivot/anchor: `[PIVOT_RULE]`
- Depth test и сортировка: `[DEPTH_RULE]`
- Тень: `[SHADOW_RULE]`
- Минимальный размер на экране: `[READABLE_PIXEL_SIZE]`
